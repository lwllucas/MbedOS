                        ...
                        gyro_odr gODR, accel_odr aODR, mag_odr mODR)
{
    ...
    // printf("from LIS3dh cpp file -> xg: %u, m: %u\r\n", xgAddress, mAddress);
    // int r = i2c.write(xgAddress, cmd, 1, true);
    // printf("write result = %d\r\n", r);
    // // Read in all the 8 bits of data
    // int result = i2c.read(xgAddress, cmd+1, 1);
    ...
    // for(int x = 0; x<255; x++){
    //     i2c.start();
    //     int r1 = i2c.write(x, cmd, 1, true);
    //     printf("address : %d , write result = %d, cmd [0]: %d\r\n", x, r1, cmd[0]);
    //     int r2 = i2c.read(x, cmd+1, 1, true);
    //     printf("address : %d , read result = %d, cmd result: %d\r\n", x, r2, cmd[1]);
    //     i2c.stop();
    // }
...
void LSM9DS1::initGyro()
{
    ...
    int result = i2c.write(xgAddress, cmd, 4);
    printf("init gyro %d\r\n", result);
...
{   
    ...
    int result = i2c.write(mAddress, cmd, 4);
    printf("init mag: %d\r\n", result);
}
...
void LSM9DS1::readAccel()
{
    ...
    // Write the address we are going to read from and don't end the transaction
    int result = i2c.write(xgAddress, &subAddress, 1, true);
    printf("%d", result);
...
bool LSM9DS1::whoAmI(){
    ...
    //acc gyro
    i2c.start();
    resulta = i2c.write(xgAddress);
    printf("result a: %d\r\n", resulta);
    resultb =i2c.write(whoAmIAddressXG);
    printf("result b: %d\r\n", resultb);
    //resultc = i2c.write(xgAddress | 1);
    resultc = i2c.write(xgAddress | 0);
    printf("result c: %d\r\n", resultc);
    ...
    //magn
    i2c.start();
    result1 = i2c.write(xgAddress);
    result2 =i2c.write(whoAmIAddressM);
    result3 = i2c.write(xgAddress | 1);
